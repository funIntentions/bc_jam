...
func _ready():
	...
	tentacle_one.set_rotd(gate_variables.tentacle_one_rot)
	tentacle_two.set_rotd(gate_variables.tentacle_two_rot)
	tentacle_three.set_rotd(gate_variables.tentacle_three_rot)
	tentacle_four.set_rotd(gate_variables.tentacle_four_rot)
